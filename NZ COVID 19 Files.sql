...
CREATE TABLE `files` (
  ...
  `url_of_download` varchar(500) NOT NULL COMMENT 'Actual URL used to download from the Government’s COVID-19 website.',
  ...
  `url_of_download_2` varchar(500) DEFAULT NULL,
